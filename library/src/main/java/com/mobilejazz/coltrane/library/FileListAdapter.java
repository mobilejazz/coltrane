...
public class FileListAdapter extends BaseAdapter {
    ...
    private final static int ICON_FOLDER = com.mobilejazz.coltrane.library.R.drawable.ic_folder;
    private final static int ICON_FILE = com.mobilejazz.coltrane.library.R.drawable.ic_file;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null)
            row = mInflater.inflate(com.mobilejazz.coltrane.library.R.layout.file, parent, false);
